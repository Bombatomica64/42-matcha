...
@Component({
  ...
  imports: [CardModule, ButtonModule, InputGroupModule,
    InputGroupAddonModule, InputTextModule, DatePickerModule,
    FormsModule, ReactiveFormsModule, Map, SelectModule,
],
  template: `
...
export class ProfileForm {
    ...
    effect(() => {
      ...
      if (profile && !editable) {
        this.profileForm.patchValue({
          ...
          sexual_orientation: (profile.sexual_orientation === 'heterosexual' || profile.sexual_orientation === 'homosexual' || profile.sexual_orientation === 'bisexual') ? profile.sexual_orientation : '',
          location: {
  ...
  onSubmit() {
    if (this.profileForm.valid) {
      ...
      if (raw.first_name && raw.first_name.trim() !== '' && raw.first_name !== profile.first_name) {
        payload.first_name = raw.first_name;
      }
      // Only send last_name if it's not empty and different
      if (raw.last_name && raw.last_name.trim() !== '' && raw.last_name !== profile.last_name) {
