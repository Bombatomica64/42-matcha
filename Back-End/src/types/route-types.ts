...
type PathParams<T extends keyof paths> = paths[T] extends { parameters: { path: infer P } } ? P : Record<string, string>;
type QueryParams<T extends keyof paths> = paths[T] extends { parameters: { query: infer Q } } ? Q : Record<string, unknown>;
