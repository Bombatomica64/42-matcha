...
// import type { components, operations, RequestBody, ResponseBody, TypedRequest } from "./api-types";
...
// 		return res
// 			.status(401)
// 			.json(createErrorResponse("No token provided", "Authorization token is required"));
// 	}
...
// 		res
// 			.status(401)
// 			.json(createErrorResponse("Invalid token", "The provided token is invalid or expired"));
// 	}
// }
